...
def load_data(config_path):
    ...
    # Load dataset path from config (defaulting to 'data/raw/insurance_data.csv')
    data_path = config.get('data_load', {}).get('dataset_path', 'data/raw/insurance_data.csv')

    # ✅ Correct GitHub raw file URL
    raw_url = "https://raw.githubusercontent.com/sundarp1438/ML-PROJECT-HEALTH_INSURANCE/main/insurance.csv"
