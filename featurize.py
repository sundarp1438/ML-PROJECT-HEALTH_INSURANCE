...
def featurize_data(config_path):
    ...
    raw_data_path = config.get('data_load', {}).get('dataset_path', 'data/raw/insurance_data.csv')
    processed_data_path = config.get('featurize', {}).get('processed_path', 'data/processed/featured_insurance_data.csv')
